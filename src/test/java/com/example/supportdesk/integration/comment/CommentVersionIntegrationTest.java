...
public class CommentVersionIntegrationTest extends AbstractCommentIntegrationTest {
    ...
    @Test
    public void shouldListCommentVersionsForDeletedCommentForAuthorOrAdmin() throws Exception {
        Ticket ticket = dataFactory.createTicket(
                user,
                "Ticket",
                "Description",
        ...
        //
        TicketComment deletedComment = dataFactory.createDeletedComment(
                user,
                ticket,
                "Deleted but versioned"
        );
